...
import com.example.soop2025.data.remote.model.response.shared.LicenseResponse
...
data class ReposSearchItemResponse(
    ...
    @SerialName("permissions") val permissions: PermissionsResponse? = null,
    @SerialName("text_matches") val textMatches: List<TextMatchResponse>? = null,
